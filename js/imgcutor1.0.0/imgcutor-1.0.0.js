...
$(function() {
	...
	(function(w) {
		...
		function open(options) {
			...
			layer.open({
				...
				yes : function(index, dom) {
					...
					var url = options.imgcuturl + '?imgUrl=' + imgUrl + '&x='
				...
				formData : {},
					...
					if (data.result.flag != undefined) {
						if (data.result.flag == "false") {
							var j_lang_err = locale=="zh_CN"?"文件上传失败！":"File upload failed!"
		...
		/* 弹出框html */
		var sLoadingImg = '<div class="loadingImg" style="position:absolute;left:180px;top:230px;width:200px; height:20px;">'
		...
		var sHtml = sLoadingImg+'<div id="imgcutor" style="width:470px;height: 470px;float: left;background: gray;margin:0 20px;"><img  id="target"></div>'
